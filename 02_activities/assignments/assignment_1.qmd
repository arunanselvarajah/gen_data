...
```         
β ≈ 0.974. The beta coefficient represents the expected change in the phenotype for each additional copy of the rs1861 minor allele under additive genetic coding. Each additional minor allele increases the phenotype by ~0.97 units on average.
```
